...
// const mapDispatch = { getTasks, getData, remove, markAsChecked, checkAll, clearCompleted, all, todo, completed }
...
//   // axios.get('/todos').then(data => setTask(data.data))
//   // const prom = axios.get('/todos').then(data => dispatch(getData(data.data)))
...
//               <input id={value.id} type="checkbox" className="promoted-input-checkbox" onClick={e => {markAsChecked(value.id)}} checked={value.checked}/>
//               <label for={value.id}>
//                 <svg>
